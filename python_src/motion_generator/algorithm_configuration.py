...
class AlgorithmConfigurationBuilder(object):
    ...
    def from_json(self, filename):
        ...
        self.strict_constrained_gmm = temp_algorithm_config["constrained_gmm_settings"]["strict"]
        self.constrained_gmm_max_bad_samples = temp_algorithm_config["constrained_gmm_settings"]["max_bad_samples"]
        self.optimization_method = temp_algorithm_config["optimization_settings"]["method"]
        self.max_optimization_iterations = temp_algorithm_config["optimization_settings"]["max_iterations"]
        self.optimization_quality_scale_factor = temp_algorithm_config["optimization_settings"]["quality_scale_factor"]
        self.optimization_error_scale_factor = temp_algorithm_config["optimization_settings"]["error_scale_factor"]
        self.optimization_tolerance = temp_algorithm_config["optimization_settings"]["tolerance"]
        self.optimization_kinematic_epsilon = temp_algorithm_config["optimization_settings"]["kinematic_epsilon"]
        self.trajectory_extraction_method = temp_algorithm_config["trajectory_following_settings"]["method"]
        self.trajectory_step_length_factor = temp_algorithm_config["trajectory_following_settings"]["step_length_factor"]
        self.trajectory_use_position_constraints = temp_algorithm_config["trajectory_following_settings"]["use_position_constraints"]
