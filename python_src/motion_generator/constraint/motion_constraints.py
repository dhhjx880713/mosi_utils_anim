    ...
    * max_step : integer
    ...
    def get_next_elementary_action_constraints(self):
        ...
        * action_constraints : ElementarActionConstraints
        ...
        if self.action_index < self.n_actions:
            action_constraint_builder.set_current_action_index(
                self.action_index)
    ...
    def _transform_from_left_to_right_handed_cs(self):
        """ Transform transition and rotation of the start pose from CAD to Opengl 
            coordinate system.
        """
        self.start_pose["orientation"] = transform_point_from_cad_to_opengl_cs(
            self.start_pose["orientation"])
        self.start_pose["position"] = transform_point_from_cad_to_opengl_cs(
