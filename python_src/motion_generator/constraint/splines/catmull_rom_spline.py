...
class CatmullRomSpline(object):
    ...
    def _initiate_control_points(self, control_points):
        ...
        self.control_points = [
            control_points[0]] + control_points + [control_points[-1], control_points[-1]]
        if self.verbose:
    ...
    def clear(self):
        # [startPoint,startPoint,startPoint]#as a workaround add multiple points at the end instead of one]
        self.control_points = []
        self.initiated = False
