...
#        return self._matrix_to_euler(q.toMat3(),rotation_channel_order)
    ...
    def _quaternion_to_euler(self, q, rotation_channel_order = ['Xrotation',
                                                                'Yrotation',
                                                                'Zrotation']):
        """
        Parameters
        ----------
        * q: numpy array
        \tA four elemenets numpy array contains quaternion [q.w, q.x, q.y, q.z]
        
        * rotation_channel_order: list of str
        \tThe order of euler rotation angles
        
        Returns
        -------
        * rotation_angles: list of floats
        \tThe rotation angles in degree in specified order
        """  
