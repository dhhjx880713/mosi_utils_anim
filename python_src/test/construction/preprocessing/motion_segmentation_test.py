...
TESTDATAPATH = ROOTDIR + os.sep + r'../test_data/constrction/motion_segmentation/Take_sidestep'
TESTRESULTPATH = ROOTDIR + os.sep + r'../test_output/constrction/motion_segmentation/cutting_results'
