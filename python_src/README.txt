...
mg_pipeline_interface.py - A simple command line interface without arguments. 
It automatically loads the latest input file in the input directory specified in config\service.json.

mg_rest_interface.py - Starts a web server that provides the following REST interface localhost:port/runmorphablegraphs.
