...
class NormalPCA(object):
    ...
    def backproect_data(self):
        ...
        self.backprojection += self.centerobj.mean
...
class FunctionalPCA(object):
    def __init__(self, data, n_knots):
        ...
        self.n_samples, self.n_frames = self.data.shape
        self.knots = get_b_spline_knots(n_knots, self.n_frames)
    ...
    def apply_pca(self, npc):
        print('pca on coeffs')
        self.centerobj = Center(self.functional_coeffs)

        self.pcaobj = PCA(self.functional_coeffs)
        self.eigenvectors = self.pcaobj.Vt[:npc]
        self.n_pcs = npc
    ...
    def get_backprojected_functional_data(self):
        ...
        backprojection += self.centerobj.mean
