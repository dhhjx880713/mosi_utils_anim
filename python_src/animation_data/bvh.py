...
class BVHWriter(object):
    ...
    * is_quaternion: Boolean
    ...
    def _quaternion_to_euler(self, q, rotation_channel_order=['Xrotation', 'Yrotation', 'Zrotation']):
        q = quat(q)
        q = q.normalize()
