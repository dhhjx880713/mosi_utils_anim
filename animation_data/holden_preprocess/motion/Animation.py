...
class Animation:
    ...
    def __init__(self, rotations, positions, orients, offsets, parents, directions):
    ...
    def __op__(self, op, other):
        return Animation(
            ...
            op(self.directions, other.directions),
    ...
    def __iop__(self, op, other):
        ...
        self.directions = op(self.directions, other.directions)
    ...
    def __setitem__(self, k, v): 
        if isinstance(k, tuple):
            ...
            self.directions.__setitem__(k[1:], v.directions)
            ...
            self.directions.__setitem__(k, v.directions)
    ...
    def copy(self): return Animation(
        ...
        self.orients.copy(), self.offsets.copy(), self.directions.copy(),
        self.parents.copy())
    ...
    def repeat(self, *args, **kw):
        return Animation(
            ...
            self.orients, self.offsets, self.parents, self.directions)
